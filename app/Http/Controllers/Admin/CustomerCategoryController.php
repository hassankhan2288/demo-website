...
class CustomerCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        //dd($lims_user_all->toArray());
        return view('admin.partials.customer_category.create',compact('lims_categories', 'lims_category_all','lims_user_all'));
    }
    ...
    public function categoryData(Request $request)
    {
        ...
        $totalData = CustomerCategory::where('is_active', true)->count();
        ...
        if(!empty($categories))
        {
            foreach ($categories as $key=>$category)
            {
                ...
                if ($category->c_id) {
                    $user = User::find($category->c_id);
                    if ($user) {
                        $nestedData['parent_id'] = $user->name;
                    } else {
                ...
                $nestedData['options'] = '<div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li class="divider"></li>'.
                                \Form::open(["route" => ["customer_category.destroy", $category->id], "method" => "DELETE"] ).'
                                <li>
    ...
    public function store(Request $request)
    {
        ...
        $lims_category_data['c_id'] = $request->c_id;
        $lims_category_data['parent_id'] = null;
        $lims_category_data['is_active'] = true;
        CustomerCategory::create($lims_category_data);
        return redirect('admin/customer_category')->with('message', 'Customer Category inserted successfully');
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('admin/customer_category')->with('message', 'Customer Category updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        if($lims_category_data->image)
            unlink('public/images/customer_category/'.$lims_category_data->image);
        $lims_category_data->save();
        return redirect('admin/customer_category')->with('not_permitted', 'Customer Category deleted successfully');
    }
}
