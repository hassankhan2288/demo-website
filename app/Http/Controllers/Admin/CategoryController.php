...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.partials.category.create',compact('lims_categories', 'lims_category_all'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $image = $request->image;
        if ($image) {
            $lims_category_data['image'] = \Helper::upload_S3_image($image,'public/images/category/','storage/images/category/');
    ...
    public function update(Request $request)
    {
        ...
        if ($image) {
            ...
            $input['image'] =\Helper::upload_S3_image($image,'public/images/category/','storage/images/category/');
        }
