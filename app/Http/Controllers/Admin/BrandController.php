...
class BrandController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.partials.brand.create', compact('lims_brand_all'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($image) {
            ...
            $input['image'] = \Helper::upload_S3_image($image,'public/images/brand/','storage/images/brand/');
        }
        Brand::create($input);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($image) {
            ...
            // $imageName = $imageName . '.' . $ext;
            // $image->move('public/images/brand', $imageName);
            $lims_brand_data->image = \Helper::upload_S3_image($image,'public/images/brand/','storage/images/brand/');
        }
