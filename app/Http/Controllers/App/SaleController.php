...
class SaleController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            return view('app.partials.sale.index',compact('starting_date', 'ending_date', 'warehouse_id', 'sale_status', 'payment_status'));
    }
    ...
    public function saleData(Request $request)
    {
        ...
        $q = Sale::where("user_id", $user->id)->whereDate('created_at', '>=' ,$request->input('starting_date'))->whereDate('created_at', '<=' ,$request->input('ending_date'));
        ...
        if(!empty($sales))
        {
            foreach ($sales as $key=>$sale)
            {
                ...
                $nestedData['options'] .= 
                    '
                                <li>
                                <a href="'.route('app.report.invoice',$sale->id).'" class="btn btn-link" target="_blank"><i class="fa fa-eye"></i>View
                                </a>
                                </li>
                                <li>
                                <a href="'.route('app.sale.status', [$sale->id,2]).'" class="btn btn-link"><i class="fa fa-close"></i>Reject
                                </a>
                                </li>
                                <li>
                                <a href="'.route('app.sale.status', [$sale->id,1]).'" class="btn btn-link"><i class="fa fa-check"></i>Completed
                                </a>
                                </li>
                                </ul>
                    ';
