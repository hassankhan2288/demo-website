...
class UpdateBranch extends Command
{
    /**
    ...
    protected $signature = 'update:branch';
     ...
     * @var string
     */
    protected $description = 'Push and pull the customer';
    ...
    public function handle()
    {
        ...
        $branches = Branch::whereNull("ms_id")->get();

        if($branches){
            foreach($branches as $branch){
                $email = $branch->email; //info@candgltd.co.uk
