...
{{-- <link rel="preload" href="{{ asset('vendor/bootstrap/css/bootstrap-select.min.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link href="{{ asset('vendor/bootstrap/css/bootstrap-select.min.css') }}" rel="stylesheet">
    </noscript>
    ...
    <noscript><link href="{{ asset('vendor/jquery-timepicker/jquery.timepicker.min.css') }}" rel="stylesheet"></noscript> 
     --}}
