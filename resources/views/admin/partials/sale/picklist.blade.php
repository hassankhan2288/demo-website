    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">Picked List</h3>
            </div>
            ...
            <div class="row ml-1 mt-2">
                ...
                <div class="col-md-2 mt-3">
                    <div class="form-group">
                        <a href="{{route('admin.sale.picklist.create',$cid)}}" class="btn btn-primary-outline sis_modal tip"
             title="New Picklist"> <i class="fa fa-plus">Create</i></a>
                    </div>
                </div>
            </div>
            {{-- {!! Form::close() !!} --}}
