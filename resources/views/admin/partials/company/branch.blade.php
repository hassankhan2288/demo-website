          ...
          <div class="card text-left">
            <div class="card-header">Add Branch</div>
              <div class="card-body">
                  ...
                  <form method="post" action="{{route('admin.company.branch.submit')}}">
                  @csrf
                  @if(isset($company_id))
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{old("phone")??$admin->phone??""}}" autocomplete="name" autofocus />
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address">{{old("address")??$admin->address??""}}</textarea>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                            <label for="inputTitle" class="col-form-label">Ms Number <span class="text-danger">*</span></label>
                             <input type="text" class="form-control" name="ms_number" value="{{old("ms_number")??$admin->ms_number??""}}" required>
