...
<script>
    ...
    var logoUrl = <?php echo json_encode(asset('img/logo.png')) ?>;
        ...
        if(product[18]) {
            ...
            if(product_image.length > 1) {
                ...
                for (var i = 0; i < product_image.length; i++) {
                    if(!i)
                        slidertext += '<div class="carousel-item active"><img src="/storage/'+product_image[i]+'" height="300" width="100%"></div>';
                    else
                        slidertext += '<div class="carousel-item"><img src="/storage/'+product_image[i]+'" height="300" width="100%"></div>';
                }
                ...
                slidertext = '<img src="/storage/'+product[18]+'" height="300" width="100%">';
            }
        }
