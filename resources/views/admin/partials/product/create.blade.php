            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form" class="was-validate">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="ms_id" class="form-control" id="code" aria-describedby="code" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="category_id[]" required multiple="multiple"
                                                class="select2-multiple form-control" data-live-search="true"
                                                data-live-search-style="begins" id="select2Multiple"
                                ...
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="p_price" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="delivery_pack" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="delivery_single" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="packing_info" class="form-control" rows="3"></textarea>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    jQuery.validator.setDefaults({
        errorPlacement: function (error, element) {
            ...
            $(element).closest('div.form-group').find('.invalid-feedback').html(error.html());
        },
