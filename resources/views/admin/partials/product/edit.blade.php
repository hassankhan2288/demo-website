                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="ms_id" id="code" value="{{$lims_product_data->ms_id}}" class="form-control" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          ...
                                          <select name="brand_id" class=" form-control" data-live-search="true" data-live-search-style="begins" title="Select Brand...">
                                ...
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          <select name="category_id" required class=" form-control" data-live-search="true" data-live-search-style="begins" title="Select Category...">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="category_id[]" multiple="multiple" required
                                                class="select2-multiple form-control category_select2"
                                                data-live-search="true" id="select2Multiple"
                                                data-live-search-style="begins" title="Select Category...">
                                                <option value="">Select Category</option>
                                                @foreach ($lims_category_list as $category)
                                                    <option value="{{ $category->id }}">
                                                        {!! str_repeat('&nbsp;', $category->level * 2) !!} {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Product Purchase Price *</strong> </label>
                                        <input type="number" name="p_price" value="{{$lims_product_data->p_price}}" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Product Price')}} (SINGLE)*</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Product Pack Price (CASE)*</strong> </label>
                                        <input type="number" name="p_price"  class="form-control" value="{{$lims_product_data->p_price}}" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Product Delivery Pack Price (CASE)*</strong> </label>
                                        <input type="number" name="delivery_pack"  class="form-control" value="{{$lims_product_data->delivery_pack}}" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Product Delivery Single Price (SINGLE)*</strong> </label>
                                        <input type="number" name="delivery_single"  class="form-control" value="{{$lims_product_data->delivery_single}}" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                ...
                                <div id="alert-qty" class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('Pack Size')}}</strong> </label>
                                        <input type="text" name="pack_size" class="form-control" value="{{$lims_product_data->pack_size}}" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="hidden" name="is_active_id" value="{{$lims_product_data->is_active}}">
                                        <label>Is active</strong> </label>
                                        <select name="is_active" class="form-control">
                                            <option {{($lims_product_data->is_active==1)?'selected':''}} value="1">Active</option>
                                            <option {{($lims_product_data->is_active==0)?'selected':''}}  value="0">Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12 mt-2">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="checkbox" @if($lims_product_data->collection==1) checked @endif name="collection" value="1">&nbsp;
                                                <label>{{trans('Collection')}}</label>
                                                <!-- <p class="italic">{{trans('for e-commerce purpose')}}</p> -->
                                            </div>
                                        </div>

                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="checkbox" name="delivery"  @if($lims_product_data->delivery==1) checked @endif value="1">&nbsp;
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endphp
                                                        <img src="{{image_url('storage/'.$image)}}" height="60" width="60">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('Allergens')}}</label>
                                        <textarea name="allergens" class="form-control" rows="3">{{str_replace('@', '"', $lims_product_data->allergens)}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="ingredients" class="form-control" rows="3">{{str_replace('@', '"', $lims_product_data->ingredients)}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('Packing Info')}}</label>
                                        <textarea name="packing_info" class="form-control" rows="3">{{str_replace('@', '"', $lims_product_data->packing_info)}}</textarea>
                                    </div>
                                </div>
                               ...
                               <!--  <div class="col-md-12 mt-3" id="batch-option">
                                ...
                                <?php
                                // dd($lims_product_data->categories);
                                if (!empty($lims_product_data->categories)) {
                                    $cat_array = [];
                                    foreach ($lims_product_data->categories as $cats) {
                                        $cat_array[] = $cats->id;
                                        // $cat_array[]['id'] = $cats->id;
                                        // $cat_array[]['name'] = $cats->name;
                                    }
                                    echo '<input id="selected_cats" type="hidden" value="' . json_encode($cat_array) . '" />';
                                }
                                ?>
                            </div>
                        </form>
...
<script type="text/javascript">
    ...
    var redirectUrl = <?php echo json_encode(url('admin/products')); ?>;
    ...
    function validate() {
        var product_code = $("input[name='ms_id']").val();
    ...
    $(document).ready(function() {
            var selected_cats = $('#selected_cats').val();
            var selected_brands = $('#selected_brands').val();
            if (selected_cats) {
                var array = JSON.parse(selected_cats);;
                // alert(typeof(array));
                selected_cats = removeDuplicates(array);
                // alert(selected_cats);
                $('.category_select2').val(selected_cats);
                $('.category_select2').trigger('change');
                // $('.category_select2').select2('data',selected_cats);
            }
            
        });

        function removeDuplicates(selected_cats) {
            return Array.from(new Set(selected_cats));
        }
