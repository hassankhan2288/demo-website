...
<section>
    <div class="container-fluid mb-2 d-flex justify-content-end">
        ...
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> {{--trans("file.Add Customer Category")--}}Add Customer Category</button>&nbsp;
        {{-- <button class="btn btn-primary" data-toggle="modal" data-target="#importCategory"><i class="dripicons-copy"></i> {{--trans('file.Import Category')-}}Import Customer Category</button> --}}
    </div>
...
<div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        {!! Form::open(['route' => 'customer_category.store', 'method' => 'post', 'files' => true]) !!}
        ...
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="row">
                ...
                <div class="col-md-6 form-group form-group"> <label>Select Company</label> <select class="form-control select2 select2-hidden-accessible" name="c_id" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
                    @foreach ($lims_user_all as $userss)
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
        {{ Form::open(['route' => ['customer_category.update', 1], 'method' => 'PUT', 'files' => true] ) }}
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group form-group"> <label>Select Company</label> 
                <input type="hidden" readonly name="c_id" class="form-control">
                <input type="text" readonly name="c_cc" class="form-control">
                {{-- <select class="form-control select2 select2-hidden-accessible" name="c_id" style="width: 100%;"  aria-hidden="true" >
                    @foreach ($lims_user_all as $userss)
...
<div id="importCategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        {!! Form::open(['route' => 'customer_category.import', 'method' => 'post', 'files' => true]) !!}
        <div class="modal-header">
...
<script type="text/javascript">
    ...
    $(document).on("click", ".open-EditCategoryDialog", function(){
          ...
          $.get(url, function(data){
            ...
            $("#editModal input[name='c_id']").val(data['c_id']);
            $("#editModal input[name='c_cc']").val(data['parent']);
    ...
    $('#category-table').DataTable( {
        ...
        "serverSide": true,
        "ajax":{
            url:"customer_category/category-data",
            dataType: "json",
            type:"post"
        },
