...
<div class="row">
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
        <a href="" class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
            <div class="card-body text-center align-items-center"><i class="i-Checkout-Basket"></i>
                <div class="content w-100 ml-4 mw-100">
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
        <a href="" class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
            <div class="card-body text-center align-items-center"><i class="i-Add-UserStar" style="font-size:3.5rem;"></i>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6">
        <a href="" class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
            <div class="card-body text-center align-items-center"><i class="i-Library" style="font-size:3.2rem;"></i>
    ...
    <div class="col-lg-4 col-sm-12">
        <div class="card mb-4">
            <button type="button" class="list-group-item list-group-item-action active">
                <svg xmlns="http://www.w3.org/2000/svg" class="mr-2" width="16" height="16" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
