...
<body>
	<section>
		<div class="row">
			<div class="col-md-12">
				<center class="mb-4 mt-2 printPageButton">
					<a href="{{route('admin.report')}}" class="btn btn-info">Back</a>
					<button class="btn btn-primary  m-r-10"  onclick="CreatePDFfromHTML()"><i class="far fa-file-pdf"></i> &nbsp; PDF</button>
					<button  onclick="window.print()" class="btn btn-primary"><i class="fas fa-print"></i> Print</button>
				</center>
			</div>
		...
		max-width: 980px;">
	      ...
	      <table style="width: 100%">
			<tr style="border-bottom:3px solid #2d4936; middle-align:center">
				<td><img src="{{asset('frontend/assets/img/cater-logo.png')}}" style="width:250px;"></td>
		...
		border-collapse: separate;" >
			<thead>
				<tr>
					...
					@if($sale->status == 'POS')
						<th class="greenbgset">Delivery Date</th>
						@endif
				</tr>
			</thead>
			<tbody>
