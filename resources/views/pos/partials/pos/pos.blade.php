...
<div class="hide-print flex flex-row md:flex-nowrap flex-wrap h-[calc(100vh-71px)] antialiased text-blue-gray-800">
  ...
  <div class="flex flex-row md:w-auto w-full flex-shrink-0 md:pl-4 pl-2 pr-2 py-4">
    <div class="flex md:flex-col items-center py-4 flex-shrink-0 md:w-20 w-full bg-[#ce1212] rounded-3xl gap-5 md:justify-start justify-center">
      ...
      <ul class="flex md:flex-col gap-5 md:mt-7">
        <li>
          <div class="text-center">
            <a href="{{route('pos.dashboard')}}" x-show="!loading" class="flex items-center mx-auto justify-center h-12 w-12 bg-red-50 text-cyan-700 rounded-full">
        ...
        <li>
          <div class="text-center md:mt-3">
            ...
            <p class="text-red-100 flex-col text-center md:block hidden">Refresh</p>
          </div>
        </li>
        <li>
          <div class="text-center">
            ...
            <p class="text-red-100 flex-col text-cente md:block hidden">Favourite Products</p>
          </div>
        </li>
        ...
        <li>
          <div class="text-center">
            ...
            <p class="text-red-100 flex-col text-center md:block hidden">View Hold Orders</p>
          </div>
        </li>
      </ul>
    </div>
  ...
  <div class="flex-grow flex xl:flex-nowrap flex-wrap">
    ...
    <div class="flex px-2 flex-row md:flex-nowrap flex-wrap relative  md:gap-2 gap-4 xl:hidden w-full md:mt-4">
      ...
      <input type="text" class="bg-white rounded-3xl shadow text-md full w-full md:h-16 h-12 md:py-4 py-2 pl-16 transition-shadow focus:shadow-2xl focus:outline-none" placeholder="Search Products" x-model="keyword" />
      <select x-model="category" id="category" class="bg-white rounded-3xl shadow text-md full w-full md:h-16 h-12 md:py-4 py-2 pl-8 transition-shadow focus:shadow-2xl focus:outline-none">
...
{{--        </select>--}}
      ...
      <div class="h-full overflow-hidden md:mt-4">
...
<div x-show="order_placed" :class="{ '!flex': order_placed }" class="fixed hidden glass w-full h-screen left-0 top-0 z-40 flex flex-wrap justify-center content-center sm:p-24 p-6"  @click.outside="order_placed = false">
  <div class="w-96 sm:p-8 p-6 bg-white shadow-xl">
    <span x-on:click="order_placed = false" style="float:right;cursor:pointer;">x</span>
    <br>
    <div class="text-center">
      <h3 class="text-center text-2xl mb-8">Order has been placed successfully.</h3>
    </div>
  </div>
</div>
<!-- end of noprint-area -->
...
<input type="hidden" id="pos-product-list" value="{{route('pos.product.list')}}">
<input type="hidden" id="pos-sale-submit" value="{{route('pos.sale.submit')}}">
...
<script type="text/javascript" src="{{ asset('js/pos.js?version=1.0.1') }}"></script>
<script>
