...
<div style="max-width:400px;margin:0 auto">
    ...
    <div id="receipt-data">
        ...
        <p>{{trans('file.Date')}}: {{strtotime($lims_sale_data->created_at->toDateString())}}<br>
        ...
        <table class="table-data">
            ...
            <!-- <tfoot> -->
                ...
                <tr>
                    ...
                    <th class="centered" colspan="3">{{trans('file.In Words')}}: <span>{{str_replace("-"," ",$numberInWords)}}</span> <span>$</span></th>
