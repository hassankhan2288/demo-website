...
<div class="alert alert-success alert-dismissible text-center d-none" id="re-order-place"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>Order successfully added. Go to pos to place order</div>
{{-- ///// --}}
<section>
    <div class="container-fluid">
        <div class="card">
            ...
            {!! Form::open(['route' => 'pos.sale.list', 'method' => 'get']) !!}
            <div class="row mx-1 mt-2 align-items-end">
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    <div class="form-group d-flex justify-content-md-start justify-content-end">
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="sale-table" class="table sale-list">
                        <thead>
                            <tr>
...
<script>
    async function loadDatabase() {
        ...
        $(document).on("click", ".re-order", function() {
            ...
            $.ajax({
                url: "{{route('pos.order.by.product')}}",
                type: "post",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                ...
                success: function(data) {
                    ...
                    window.location = "{{route('pos.sale.pos')}}"
                }
            });
        })
    }
