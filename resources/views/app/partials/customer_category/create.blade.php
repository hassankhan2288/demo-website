...
<section>
    <div class="container-fluid text-right mb-2">
        ...
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> {{--trans("file.Add Customer Category")--}}Add Category</button>&nbsp;
...
<div id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            {!! Form::open(['route' => 'customers_category.store', 'method' => 'post', 'files' => true]) !!}
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            {{ Form::open(['route' => ['customers_category.update', 1], 'method' => 'PUT', 'files' => true] ) }}
            <div class="modal-header">
...
<script type="text/javascript">
    ...
    $('#category-table').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "customers_category/category-data",
            dataType: "json",
            type: "post"
        },
