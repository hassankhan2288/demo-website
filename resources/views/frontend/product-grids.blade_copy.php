...
@php
    ...
    $value = \App\Category::where('id', $cate)->get();
    //dd($value[0]->name)
@endphp
@section('main-content')
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">@php if(isset($value[0]->name)) {
                                    echo $value[0]->name;
                                } else {
                                    echo 'Products';
                            } @endphp</a></li>
    ...
    <?php if(session()->get('design') == 'grid'){
                            ...
                            <div class="single-widget category">
                                ...
                                <div class="dropdown">
                                    ...
                                    @if ($menu)
                                        @foreach ($menu as $cat_info)
                                            ...
                                            ?>
                                            @if (count($sub_cat) > 0)
                                                <a class="sidemenullist dropdown-toggle" href="#" role="button"
                                                    id="dropdownMenuLink{{ $cat_info->id }}" data-bs-toggle="dropdown"
                                                    aria-expanded="false">
                                                    {{ $cat_info->name }}
                                                </a>
                                            ...
                                            @else
                                                <a class="btn btn-secondary " href="{{route('product-cat',$cat_info->id)}}" role="button"
                                ...
                                {{-- <ul class="categor-list">
										...
										<li>
                                           ...
                                           ?>
													@if (count($sub_cat) > 0)
														<li class="dropdown"><a href="{{route('product-cat',$cat_info->id)}}">{{$cat_info->name}}</a>
															<ul>
																@foreach ($sub_cat as $sub_menu)
																	<li><a href="{{route('product-cat',$sub_menu->id)}}">{{$sub_menu->name}}</a></li>
																@endforeach
															</ul>
														</li>
													@else
														<li><a href="{{route('product-cat',$cat_info->id)}}">{{$cat_info->name}}</a></li>
													@endif
											@endforeach
										</li>
										@endif
                            ...
                            {{-- <div class="single-widget recent-post">
                                    ...
                                    @foreach ($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            <div class="image">
                                                <img src="{{asset('storage/300x300/'.$photo[0])}}" alt="{{$photo[0]}}">
                                            </div>
                                            <div class="content">
                                                <h5><a href="{{route('product-detail',$product->id)}}">{{$product->name}}</a></h5>
                                                {{-- @php
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="shop-top">
                                        ...
                                        <div class="single-shorter">
                                            ...
                                            <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                                ...
                                                <option value="name" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'name') selected @endif>
                                                    Name</option>
                                                <option value="price?sort=asc" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'price?sort=asc') selected @endif>
                                                    Price (Lowest To Highest)</option>
                                                <option value="price?sort=desc" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'price?sort=desc') selected @endif>
                                    ...
                                    <ul class="view-mode">
                                        <li class="active"><a href="{{ URL::to('design', ['id' => 'grid']) }}"><i
                                                    class="fa fa-th-large"></i></a></li>
                                        <li><a href="{{ URL::to('design', ['id' => 'list']) }}"><i
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        <div class="single-product">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <h3 class="title">{{ $product->code }}</h3>
                                                <h3 class="title">{{ $product->pack_size }}</h3>
                                                {{-- @php
                                        ...
                                        <li>
                                            @foreach ($menu as $cat_info)
                                                {{-- @if ($cat_info->child_cat->count() > 0)
													...
													@else -}}
                                        <li><a href="{{ route('product-cat', $cat_info->id) }}">{{ $cat_info->name }}</a>
                                        </li>
                                        {{-- @endif -}}
                                    @endforeach
                                    </li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="shop-top">
                                        ...
                                        <div class="single-shorter">
                                            ...
                                            <select class="show" name="show" onchange="this.form.submit();">
                                                ...
                                                <option value="9" @if (!empty($_GET['show']) && $_GET['show'] == '9') selected @endif>
                                                    09</option>
                                                <option value="15" @if (!empty($_GET['show']) && $_GET['show'] == '15') selected @endif>
                                                    15</option>
                                                <option value="21" @if (!empty($_GET['show']) && $_GET['show'] == '21') selected @endif>
                                                    21</option>
                                                <option value="30" @if (!empty($_GET['show']) && $_GET['show'] == '30') selected @endif>
                                                    30</option>
                                            </select>
                                        </div>
                                        <div class="single-shorter">
                                            ...
                                            <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                                ...
                                                <option value="category"
                                                    @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'category') selected @endif>Category</option>
                                                <option value="brand" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'brand') selected @endif>
                                                    Brand</option> --}}
                                            </select>
                                        </div>
                                    ...
                                    <ul class="view-mode">
                                        <li><a href="{{ URL::to('design', ['id' => 'grid']) }}"><i
                                                    class="fa fa-th-large"></i></a></li>
                                        <li class=""><a href="{{ URL::to('design', ['id' => 'list']) }}"><i
                                                    class="fa fa-th-list"></i></a></li>
                                    </ul>
                                </div>
                                <!--/ End Shop Top -->
                                                    ...
                                                    <div class="product-img">
                                                        <a href="{{ route('product-detail', $product->id) }}">
                                                            ...
                                                            <img class="default-img"
                                                                src="{{ asset('storage/300x300/' . $photo[0]) }}"
                                                                alt="{{ $photo[0] }}">
                                                            @if (isset($photo[1]))
                                                                <img class="hover-img"
                                                                    src="{{ asset('storage/300x300/' . $photo[1]) }}"
                                                                    alt="{{ $photo[1] }}">
                                                            @endif
                                                        </a>
                                                        <div class="button-head">
