    ...
    <div class="!container mx-auto px-6">
        <div class="flex flex-wrap justify-center py-[40px]">
            <div class="sm:w-[400px] w-full mx-auto mt-[25px] mb-[50px] shadow-[0px_15px_66px_5px_#d9d9d9cc] p-[30px]">
                ...
                <div class="mb-[20px]">
                    <input id="email" type="email" placeholder="Email" class="p-[8px_15px] rounded-[4px] !border !border-[#ce1212]/10 w-full focus:border-[#ce1212]/30 focus-visible:!border-[#ce1212]/30 focus-visible:outline-0 @error('email') is-invalid @enderror" name="email" value="" required  autofocus>
                    @error('email')
                ...
                <div class="mb-[20px]">
                    <input id="password" type="password" placeholder="Password" class="p-[8px_15px] rounded-[4px] !border !border-[#ce1212]/10 w-full focus:border-[#ce1212]/30 focus-visible:!border-[#ce1212]/30 focus-visible:outline-0 @error('password') is-invalid @enderror" name="password" value="" required  autofocus>
                    @error('password')
                        <span class="text-red" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <button class="p-[10px_30px] w-full rounded-full text-white bg-[#ce1212]">{{ __('Reset') }}</button>
