...
<div class="bg-white !border !border-[#ce1212]/10 rounded-[5px] p-[15px] group">
    <a href="{{ route('product-detail', $product->slug?? ' ') }}" >
        ...
        <div class="text-center">
            <a href="{{ route('product-detail', $product->slug?? ' ') }}" class="hover:text-[#ce1212] font-bold py-[5px] block height-[45px]">{{ $product->name }}</a>
...
{{--            @endif--}}
            ...
            {{-- <div class="qty-input w-100 justify-center">
                ...
                <input class="product-qty w-75" type="number" name="quant[1]"  class="w-[70px] p-[8px_5px] rounded-[5px] !border border-[#ce1212]/10" min="1" max="10" data-min="1" data-max="10" value="1" id="quantity">
...
{{--        </a>--}}
{{--        <a href="{{ route('product-detail', $product->slug?? ' ') }}" class="bg-[#ce1212]/10 hover:bg-[#ce1212] hover:text-white text-[#ce1212] p-[10px_15px] rounded-[50%] w-[32px] h-[32px] flex items-center justify-center ml-auto">--}}
