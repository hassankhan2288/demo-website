    ...
    const app = {
            ...
            if (json != undefined) {
                if (json.status == 200) {
                    ...
                    for (let product of data.data) {
                        // let imagePath = product.product.image.split(",")[1] || product.product.image.split(",")[0];
                        let imagePath = product.product.image.split(",")[1] || product.product.image.split(",")[0];

                        // Remove '/storage' if it's present in the imagePath
                        ...
                        await this.db.addProduct({
                            ...
                            // image: "https://cater-choice-assets.s3.eu-west-2.amazonaws.com/storage/thumbnail/" + product.product.image.split(",")[1],
                            // image: imageURL.toString(),
                            image: "https://cater-choice-assets.s3.eu-west-2.amazonaws.com/storage/thumbnail/" + imagePath,
            ...
            if (json != undefined) {
                if (json.status == 200) {
                    ...
                    for (let product of data.data) {
                        ...
                        // console.log("Product Image:", product.product && product.product.image);

                        if (product && product.product && product.product.image !== null && product.product.image !== undefined && product.product.image !== "") {

                            // let imagePathParts = product.product.image.split(",")[0].split("thumbnail/");
                            // let imagePath = imagePathParts.length > 1 ? imagePathParts[1] : imagePathParts[0];
                            //
                            // imageUrl = "https://cater-choice-assets.s3.eu-west-2.amazonaws.com/storage/thumbnail/" + imagePath;
                            // console.log('imageUrl', imageUrl)

                            let imagePathParts = product.product.image.split(",");
                            let imagePath = imagePathParts.length > 1 ? imagePathParts[1] : (imagePathParts[0] || '');
                            ...
                            // imageUrl = "https://cater-choice-assets.s3.eu-west-2.amazonaws.com/storage/thumbnail/" + product.product.image.split(",")[1];
                        ...
                        //     isTaxCalculate: product.tax_method == 1 ? true : false,
                        //     is_favorite: product.is_favorite == 1 ? true : false,
                        //     options: null
                        // });
                    }
        ...
        async addToCart(product, priceType) {
            ...
            if (priceType === 'price' && product.price !== undefined) {
                ...
                let item = {
                    ...
                    product_tax: product.tax_rate ? (product.tax_rate / 100) * price.value : 0,
                    type: type,
                    qty: 1,
                };
        ...
        sale() {
            return {
                ...
                total_discount: 0,
                // total_tax: 0,
                total_price: this.getSubTotalPrice(),
