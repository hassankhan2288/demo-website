...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Notify'),
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '66c8949c67b6134f4f0a2d773bf1c676'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', 'a34ae717645730e6802acec382f764d9'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,read_customers,read_orders,read_inventory,read_fulfillments,read_merchant_managed_fulfillment_orders,read_shipping'),
    ...
    */
    ...
    'api_redirect' => env('SHOPIFY_API_REDIRECT', 'http://127.0.0.1:8000/app/shopify/authenticate'),
    ...
    */
    ...
    'webhooks' => [
            [
                'topic' => 'carts/create',
                'address' => 'carts-create',
                'info' => 'Trigger when customer add product to cart',
            ],
            [
                'topic' => 'customers/create',
                'address' => 'customers-create',
                'info' => 'Trigger when new customer registered',
            ],
            [
                'topic' => 'fulfillments/create',
                'address' => 'fulfillments-create',
                'info' => 'Trigger when order update or fulfillments',
            ],
            [
                'topic' => 'inventory_levels/update',
                'address' => 'inventory_levels-update',
                'info' => 'Trigger when inventory level updated',
            ],
            [
                'topic' => 'orders/create',
                'address' => 'orders-create',
                'info' => 'Trigger when new order created',
            ],
    ],
